...
{
var x=document.forms["userinfo"]["Username"].value;
var y=document.forms["userinfo"]["Password"].value;
var z=document.forms["userinfo"]["eAddress"].value;
var o=document.forms["userinfo"]["Password2"].value;
var c=document.forms["userinfo"]["fname"].value;
var d=document.forms["userinfo"]["lname"].value;
var a=document.getElementById("male").checked;
var b=document.getElementById("female").checked;

if (x==null || x=="")
  {
  alert("Username must not be blank "+c);
  return false;
  }
else if (y==null || y=="")
  {
...
<form action="addinfo.php" method="post" name="userinfo" onsubmit="return validateForm()">
<table cellpadding="10px" cellspacing="10">
    <tr>
    	<th>Username</th>
        <th><input name="Username" type="text" size="50" /></th>              
    </tr>
    <tr>
    	<th>Password</th>
        <th><input name="Password" type="password" size="50" /></th>
    </tr>
    <tr>
    	<th>Confirm Password</th>
        <th><input name="Password2" type="password" size="50" /></th>
    </tr>
    <tr>
    	<th>Email Address</th>
        <th><input name="eAddress" type="email" size="50" /></th>
    </tr>
     <tr>
    	<th>First Name</th>
        <th><input name="fname" type="text" size="50" /></th>
    </tr>
     <tr>
    	<th>Last Name</th>
        <th><input name="lname" type="text" size="50" /></th>
    </tr>
    ...
    <h3>Select country of origin</h3>
...
<option value="Zimbabwe">Zimbabwe</option>
     ...
     <input type="reset" name="Reset" value="Reset"/> </center></form>
