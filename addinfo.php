...
<div id="wrap">
  ...
  <?php
	...
	$query3 = "INSERT INTO userinfo (Username, Password, Email, country, sex, fname, lname) VALUE('".$_REQUEST['Username']."','".$_REQUEST['Password']."','".$_REQUEST['eAddress']."','".$_REQUEST['countries']."','".$_REQUEST['sex']."','".$_REQUEST['fname']."','".$_REQUEST['lname']."')";
